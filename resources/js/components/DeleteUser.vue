...
<template>
    <div class="space-y-6">
        <HeadingSmall title="Excluir conta" description="Delete your account and all of its resources" />
                ...
                <DialogContent>
                    <form class="space-y-6" @submit="deleteUser">
                        <DialogHeader class="space-y-3">
                            ...
                            <DialogDescription>
                                Uma vez que sua conta for excluída, todos os seus recursos e dados também serão permanentemente apagados. Por favor, insira sua senha para confirmar que deseja excluir sua conta permanentemente.
                            </DialogDescription>
                        </DialogHeader>
